...
{
    public partial class TVFilter : UserControl
    {
        ...
        private string tvFilterUri = "http://www.piemeram.lv/JjxJNdbf/TvFilter.php";
        ...
        private async void UpdateYears()
        {
            ...
            byte[] content = await webClient.DownloadDataTaskAsync(tvFilterUri + "?req=year&genre=");
        ...
        {
            webClient = new WebClient();
            byte[] content = await webClient.DownloadDataTaskAsync(tvFilterUri + "?req=genre&year=");
        ...
        private void Search()
        {
            ...
            main.containerCovers.Children.Add(new Covers("TV", cmbOrder.Text, genre, year, txtName.Text, null));
